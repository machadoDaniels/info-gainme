...
cities_pops = pd.read_csv(data_dir / "cities_pops.csv")
...
out_path = data_dir / "world_flat.csv"
world_flat.to_csv(out_path, index=False)
print(f"Dados salvos em: {out_path}")

out_path = data_dir / "world_flat_clean.csv"
world_flat_clean.to_csv(out_path, index=False)
print(f"Dados salvos em: {out_path}")

out_path = data_dir / "top_40_pop_cities.csv"
top_40_pop_cities.to_csv(out_path, index=False)
print(f"Dados salvos em: {out_path}")

out_path = data_dir / "top_20_pop_cities.csv"
top_20_pop_cities.to_csv(out_path, index=False)
print(f"Dados salvos em: {out_path}")

out_path = data_dir / "top_10_pop_cities.csv"
top_10_pop_cities.to_csv(out_path, index=False)
print(f"Dados salvos em: {out_path}")